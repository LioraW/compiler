...
const int table[last_state][LAST_TK] = {
    // a        1         A         _         =          <         >         !         :         (         )         [         ]         {         }         ,         .         +         -         *           /        %       ;           WS
    ...
    { BANG_ERR, BANG_ERR, BANG_ERR, BANG_ERR, NTEQ_TK,   BANG_ERR, BANG_ERR, BANG_ERR, BANG_ERR, BANG_ERR, BANG_ERR, BANG_ERR, BANG_ERR, BANG_ERR, BANG_ERR, BANG_ERR, BANG_ERR, BANG_ERR, BANG_ERR, BANG_ERR,  BANG_ERR, BANG_ERR, BANG_ERR,  }, // s9 (from !)
    { COLN_TK,  COLN_TK,  COLN_TK,  COLN_TK,  COLNEQ_TK, COLN_TK,  COLN_TK,  COLN_TK,  COLN_TK,  COLN_TK,  COLN_TK,  COLN_TK,  COLN_TK,  COLN_TK,  COLN_TK,  COLN_TK,  COLN_TK,  COLN_TK,  COLN_TK,  COLN_TK,   COLN_TK,  COLN_TK,  COLN_TK,   }, // s10 (from :)
    { s2,       s11,      s4,       s5,       ID_TK,     ID_TK,    ID_TK,    ID_TK,    ID_TK,    ID_TK,    ID_TK,    ID_TK,    ID_TK,    ID_TK,    ID_TK,    ID_TK,    ID_TK,    ID_TK,    ID_TK,    ID_TK,     ID_TK,    ID_TK,    ID_TK,    }, // s11 (from number after a letter or underscore) 
