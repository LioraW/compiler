...
PARSER_SRCS = parser.cpp parser.h tree.h tree.cpp node.h
MAIN_SRC = main.cpp
...
OBJS = main.cpp parser.cpp parser.h testScanner.cpp testScanner.h token.cpp token.h scanner.cpp scanner.h FSAtable.h tokenID.h Characters.h tree.h tree.cpp node.h
